        ...
        <motion.div className="contact conatiner-fluid"
            ...
            <div className="contact-content-con">
                <div className="left-contact">
                    ...
                    <div className="conbut" style={{ display: 'flex' }}>
                        ...
                        <div className="btn-con">
                            <a className="main-btn" href="https://drive.google.com/uc?export=view&id=12_q8k7pfS3Nc7vEfaT_6dMMUR3lzLQs7">
                ...
                <div className="right-contact">
                    <h2>CONTACT ME</h2>
                    <form action="https://formsubmit.co/79f4a408b7f0fd165a4c027b4a1c2cfc" method="POST" target="_blank" className="contact-form">
                        <div className="input-control i-c-2">
                            <i className="fa-solid fa-user fa-1x" style={{ marginTop: '14px', position: 'absolute', marginLeft: '10px' }}></i><input type="text" required placeholder="Enter Name" name="name" />
                            <i className="fa-solid fa-envelope " style={{ position: 'absolute', marginLeft: '324px', marginTop: '13px' }}></i><input type="email" required placeholder="Enter Email" name="email" />
                        </div>
                        <div className="input-control">
                            <i className="fa-solid fa-note-sticky" style={{ position: 'absolute', margin: '14px 11px' }}></i>
                            <input type="text" required placeholder="Enter Subject" name="subject" />
                        </div>
                        <div className="input-control">
                            <i className="fa-solid fa-message" style={{ position: 'absolute', margin: '16px 11px' }}></i><textarea type="text" name="message" cols="15" rows="8" placeholder="Type your message here..." ></textarea>
                            {/* <input type="hidden" name="_captcha" value="false" /> */}
                        </div>
                        <input type="hidden" name="_url" value="https://yourdomain.co/contact.html"></input>
                        <button type="submit" className="subtext">Submit<i className="fa-sharp fa-solid fa-paper-plane"></i></button>
                    </form>
                </div>
            </div>
        </motion.div>
